...
public class Bilheteria {
    ...
    public void addEvento(String nome) {
        ...
        repEventos.put(nome, new Evento(nome));
    }

    public void addSetor(String nomeEvento, String nomeSetor, double preco) {
        Evento evento = getEvento(nomeEvento);
        evento.addSetor(nomeSetor, preco);
    }

    public void vender(String nomePessoa, String nomeEvento, String nomeSetor) {
        Pessoa pessoa = getPessoa(nomePessoa);
        Evento evento = getEvento(nomeEvento);
        Setor setor = evento.getSetor(nomeSetor);
        repVendas.add(new Venda(pessoa, evento, setor));
    }
